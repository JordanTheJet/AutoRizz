...
class ProviderManager @Inject constructor(
    ...
    override var lastFailoverEvent: FailoverEvent? = null
        private set
    ...
    override fun switchProvider(type: String) {
    ...
    override fun activeType(): String = appConfig.providerType

    /** Get all available provider types */
    override fun availableProviders(): List<ProviderInfo> = listOf(
    ...
    override fun hasKey(type: String): Boolean = secureKeyStore.hasApiKey(type)

    /** Store an API key for a provider */
    override fun setApiKey(type: String, apiKey: String) {
        secureKeyStore.storeApiKey(type, apiKey)
    }

    /** Remove an API key for a provider */
    override fun removeApiKey(type: String) {
