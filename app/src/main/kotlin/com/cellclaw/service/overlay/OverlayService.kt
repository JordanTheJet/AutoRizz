...
class OverlayService : Service() {
    ...
    private fun createBubble() {
        ...
        val bubble = ImageView(this).apply {
            ...
            val bg = GradientDrawable().apply {
                ...
                setColor(Color.parseColor("#0D8A2E"))
            }
            background = bg
    ...
    private fun createStatusView() {
        val tv = TextView(this).apply {
            ...
            val bg = GradientDrawable().apply {
                setColor(Color.parseColor("#CC0A120A"))
    ...
    private fun createResponseCard() {
        val card = LinearLayout(this).apply {
            ...
            val bg = GradientDrawable().apply {
                setColor(Color.parseColor("#E60A120A"))
                cornerRadius = dpToPx(12).toFloat()
            }
            background = bg
    ...
    private fun createPanel() {
        val panel = LinearLayout(this).apply {
            orientation = LinearLayout.VERTICAL
            val bg = GradientDrawable().apply {
                setColor(Color.parseColor("#0A120A"))
        ...
        val askInput = EditText(this).apply {
            ...
            setTextColor(Color.WHITE)
            setBackgroundColor(Color.parseColor("#1A261A"))
    ...
    private fun createHelpGuide() {
        val content = LinearLayout(this).apply {
            orientation = LinearLayout.VERTICAL
            val bg = GradientDrawable().apply {
                setColor(Color.parseColor("#F00A120A"))
                cornerRadius = dpToPx(16).toFloat()
            }
            background = bg
        ...
        addGuideSection(content, "\uD83D\uDD35 Logo",
            "The floating bubble uses the AutoRizz icon. " +
        ...
        addActionRow(content, "\u2605 Star", "Open the full AutoRizz app")
        ...
        addActionRow(content, "Double Tap", "Open the full AutoRizz app")
