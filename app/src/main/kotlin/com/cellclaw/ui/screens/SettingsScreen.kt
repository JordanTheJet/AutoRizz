            ...
            Card(
                ...
                modifier = Modifier
                    ...
                    .clickable {
                        ...
                        val refresh = viewModel.refreshToken
                        val url = if (token != null && refresh != null) {
                            "https://autorizz.app/auth/app-handoff#access_token=$token&refresh_token=$refresh"
                        } else {
                            "https://autorizz.app/dashboard/credits"
                        }
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Row(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            ...
                            Text(
                                "Let AutoRizz install apps from the Play Store when needed",
                                style = MaterialTheme.typography.bodySmall,
                                color = MaterialTheme.colorScheme.onSurfaceVariant
                            )
                        }
                ...
                Row(
                    ...
                    Row(
                        ...
                        Column {
                            ...
                            Text(
                                "Control which apps AutoRizz can interact with",
                                style = MaterialTheme.typography.bodySmall,
                                color = MaterialTheme.colorScheme.onSurfaceVariant
                            )
                            Text(
