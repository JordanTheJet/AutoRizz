...
fun GuideScreen(onBack: () -> Unit) {
    Scaffold(
        ...
        Column(
            ...
            GuideSection(
                title = "\uD83D\uDD35 Logo",
                body = "The floating bubble uses the AutoRizz icon. " +
            ...
            GuideSection(
                ...
                body = null,
                items = listOf(
                    "\u2139 Info" to "Open the AutoRizz guide",
                    "\u2605 Star" to "Open the full AutoRizz app",
            ...
            GuideSection(
                ...
                items = listOf(
                    ...
                    "Double Tap" to "Open the full AutoRizz app",
